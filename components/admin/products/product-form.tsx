      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <Select defaultValue={initialData?.condition ?? undefined} onValueChange={(val) => val && setValue("condition", val)}>
          ...
          {variants.map((variant, i) => (
            <div key={i} className="grid grid-cols-2 md:grid-cols-6 gap-2 items-end">
              ...
              <div>
                ...
                <Input value={variant.color ?? ""} onChange={(e) => updateVariant(i, "color", e.target.value)} placeholder="Black" className="mt-1 h-8 text-sm" />
              </div>
              <div>
